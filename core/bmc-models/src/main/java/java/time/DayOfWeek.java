...
public enum DayOfWeek implements TemporalAccessor, TemporalAdjuster {
    ...
    /** A DayOfWeek supports exactly the DAY_OF_WEEK field, like the JDK. */
    ...
    public long getLong(TemporalField field) {
        ...
        throw fail("bmc4j: unmodelled member java.time.DayOfWeek.getLong(java.time.temporal.TemporalField) — only DAY_OF_WEEK is modeled for this 1-based-value enum");
    }
