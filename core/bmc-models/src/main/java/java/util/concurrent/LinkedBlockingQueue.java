 ...
 */
@BmcModelConforms("inherits the ArrayBlockingQueue FIFO model (incl. stream()); unbounded-by-default logical capacity")
@BmcModelTail(reason = "array-snapshot/parallel-stream views, bulk/functional/timed ops and bounded drainTo not inherited from the ArrayBlockingQueue model — out of scope for the FIFO model; all loud under JBMC")
