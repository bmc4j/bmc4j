...
class HashMapLaws {
    ...
    // The presizing factory java.util.HashMap.newHashMap(int) is Java 19+, so its proof lives in the
    // jvm21+ source set (src/test21, proofs.hashmap.HashMapNewFactoryLaws) — it cannot resolve on the
